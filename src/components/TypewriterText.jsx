...
const TypewriterText = ({ 
  ...
  }, [currentIndex, isDeleting, text, speed, deleteSpeed, pauseTime, loop, shouldStart, hasStarted, onComplete]);
  ...
  const renderText = () => {
    if (displayText.length <= 19) {
      ...
      // Second line: "developer in 6 months"

...
const faqs = [
  {
    q: "আমি কীভাবে UPI দিয়ে পেমেন্ট করব?",
    a: 'যে কোনো কোর্সে "Buy Now" ক্লিক করুন, আপনার UPI নম্বর ও ট্রানজ্যাকশন আইডি লিখুন এবং অ্যাডমিন অনুমোদনের জন্য অপেক্ষা করুন।',
  },
  {
